...
| 수험표 ZIP 파일명 | `admission_ticket_{receiptNumber}.pdf` | `admission_ticket_{접수번호}.pdf` (`applicantId` 를 네 자리로 채운 `0001` 꼴). #254 부터 ZIP 을 없애고 1차 합격자 수험표를 PDF 하나로 준다(`documents/features/admission-ticket-print`) |
