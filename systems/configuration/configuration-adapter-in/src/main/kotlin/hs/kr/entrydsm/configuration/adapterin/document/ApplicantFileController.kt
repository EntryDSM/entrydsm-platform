...
/**
 * 지원자 한 명에게 하나씩 있는 원서·수험표. 원서는 요청자 본인 것만 주고, 수험표는 경로의 applicantId
 * (원서 생성 API `POST /api/application/v11/applicants` 응답의 값)로 찾는다.
 * 누가 다운로드할 수 있는지는 FileCategory 권한표가 정한다.
 */
@RestController
