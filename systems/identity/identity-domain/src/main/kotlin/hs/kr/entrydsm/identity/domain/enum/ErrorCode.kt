...
enum class ErrorCode(
    ...
    PASS_PROVIDER_UNAVAILABLE(503, "PASS 인증 서비스를 일시적으로 사용할 수 없습니다."),
    PASS_PROOF_STORE_UNAVAILABLE(503, "PASS 인증 정보를 일시적으로 저장할 수 없습니다."),
    PASS_PROOF_NOT_FOUND(404, "PASS 인증 정보가 없거나 만료되었습니다."),
